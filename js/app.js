...
class TaskSchedulerPro {
    ...
    renderTaskCard(task) {
        ...
        return `
            <div class="task-card priority-${task.priority} ${task.completed ? 'completed' : ''} ${isOverdue && ! task.completed ? 'overdue' : ''}" 
                ...
                <div class="task-card-inner">
                    ...
                    <div class="task-content">
                        ...
                        <div class="task-meta">
                            ...
                            ${isOverdue && !task.completed ?  '<span class="task-badge overdue">⚠️ Atrasada</span>' : ''}
                            ${task.reminder && task.reminder !== 'none' ? '<span class="task-badge">🔔 Lembrete</span>' : ''}
                        </div>
                    </div>
                    
                    <div class="task-actions">
                        <button class="task-action-btn" onclick="app.openTaskModal('${task.id}')" title="Editar tarefa">
                            <span>✏️</span>
                        </button>
                        <button class="task-action-btn delete" onclick="app.deleteTaskPrompt('${task.id}')" title="Excluir tarefa">
                            <span>🗑️</span>
                        </button>
                    </div>
                </div>
